...
class QiniuService extends BaseService
{
    ...
    public static function speechNew($data,$uid)
    {
        ...
        $command = "/usr/local/ffmpeg/bin/ffmpeg -i {$voice} -acodec pcm_s16le -f s16le -ac 1 -ar 16000 {$wav}";
        //echo $command.'---------';
        $command1 = $command;
